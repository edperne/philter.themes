  ...
  <div class="container">
    ...
    <div id="others-images" class="card-columns" >
      ...
      >
        ...
        <button class="btn btn-primary btn-sm" v-on:click="deleteImage(image)"> Delete this image</button>
      </div>
...
/*
      deleteImage(image_id) {
        url='http://bit703.module6/api/v1/users/delete/${image_id}';
